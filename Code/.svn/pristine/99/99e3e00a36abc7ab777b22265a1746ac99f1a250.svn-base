<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sb_whsysbqkcx.aspx.cs" Inherits="JlueTaxSystemHeBeiGS.BsfwtWeb.pages.sb.whsyjsf.sb_whsysbqkcx" %>

<!doctype html>
<html>
    <head>
        <title>我要文化事业建设费申报</title>
        ...
        <script src="../../../scripts/pagejs/sb/whsyjsf/whsysbqkcx.js" type="text/javascript"></script>
