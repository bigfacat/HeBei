        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                if (method == "Clear")
                {
                    ...
                    string path = System.Web.Configuration.WebConfigurationManager.AppSettings["Practicepath"] + "/APIPractice/Chongzuo.asmx/GetHeBeiData?UserId=" + userId + "&ClassId=" + ClassId + "&SortId=" + SortId + "&courseId=" + ConfigurationManager.AppSettings["CourseId"];
                    string resut = p.HttpGetFunction(path);
                    string billpath = System.Web.Configuration.WebConfigurationManager.AppSettings["tikupath"] + "/GTX/GDTXHeBeiUserYSBQC/RedoAllQuestionsHeBei";
