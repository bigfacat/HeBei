<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ycqh.aspx.cs" Inherits="JlueTaxSystemHBGS.wszx_web.apps.views.yybs.ycqh" %>
...
<head>
    ...
    <link rel="stylesheet" href="dtsk.css">
</head>
<body>
    <div id="wizard"></div>
