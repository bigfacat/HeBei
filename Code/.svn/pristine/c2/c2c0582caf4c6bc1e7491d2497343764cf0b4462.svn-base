...
if (Api.mock) {
    ...
    $.extend(Api, {
        bz: '../../../api/baseCode/CombSelect/common/DM_GY_HB.ashx', // 币种
...
window.wssqUtil = function () {
    ...
    wssq.prepareValidate = function () {
        ...
        var url = '../../../api/validate/beforehand/' + null3 + '/' + null1 + '.ashx';
        //var url = '../../../api/validate/beforehand/110104/4.ashx?' + code + '/' + id;
...
; (function (root, factory) {
    ...
    var checkVersionUrl = '../../../api/baseCode/get/version.ashx';
...
blzt.wcPageLoadMsg = function (blztDm) {
    if (!!blztDm) {
        var yltjTemplate = wssqUtil.loadTemplate('../ckzhzhbg/YltjView.aspx');
