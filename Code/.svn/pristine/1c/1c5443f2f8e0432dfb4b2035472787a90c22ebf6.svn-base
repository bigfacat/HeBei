<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sb_grcxcklxsdssbqkcx_5.aspx.cs" Inherits="JlueTaxSystemHeBeiGS.BsfwtWeb.pages.sb.grcxcklxsds.sb_grcxcklxsdssbqkcx_5" %>
...
<html>
	<head>
		...
		<script src="../../../scripts/pagejs/sb/grcxcklxsds/sb_grcxcklxsdssbqkcx_5.js" type="text/javascript"></script>
		<style type="text/css">
		body {
			margin: 0;
			padding: 0;
