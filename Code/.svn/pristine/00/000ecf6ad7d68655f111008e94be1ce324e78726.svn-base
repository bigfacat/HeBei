<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="print_nssbb_zzfw_zzsyj.aspx.cs" Inherits="JlueTaxSystemHeBeiGS.yhs_web.wssb.sjcx.print_nssbb_zzfw_zzsyj" %>
	...
	<table border="0" width=791 height="124" align="center"
		...
		<tr class="list-head-bg" height=25>
			...
			<td width="460"><div align=left class="mypop">
					<b>增值税预缴税款表【申报日期：2017-01-12，税额(90381.09)】</b>
				</div></td>
			<td width="300">
				<div class="bottom_btn_div">
					<a href="sb_zzsyjsk_201605.aspx?jspLogic=print&k=0" target="_blank">查看明细</a>
				</div>
			</td>
		</tr>
