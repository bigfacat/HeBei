<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cwkjzdba.aspx.cs" Inherits="JlueTaxSystemHBGS.wszx_web.apps.views.cwkjzdba.cwkjzdba" %>
...
<head>
    ...
    <link rel="stylesheet" href="cwkjzdba.css">
</head>
<body>
    <div id="wizard"></div>
    ...
    <script src="cwkjzdbaService.js"></script>
    <script src="cwkjzdba.js"></script>
</body>
</html>
