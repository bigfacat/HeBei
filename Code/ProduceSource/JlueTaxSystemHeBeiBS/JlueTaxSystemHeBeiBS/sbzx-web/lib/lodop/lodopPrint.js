...
function getLodop(oOBJECT,oEMBED){
    ...
    var strHtmInstall="<br><font color='#FF00FF'>打印控件未安装!点击这里<a href=" + lodopPath + "CLodop_Setup_for_Win32NT_https_2.102.exe target='_self'>执行安装</a>,安装后请刷新页面或重新进入。</font>";
    var strHtmUpdate="<br><font color='#FF00FF'>打印控件需要升级!点击这里<a href=" + lodopPath + "CLodop_Setup_for_Win32NT_https_2.102.exe target='_self'>执行升级</a>,升级后请重新进入。</font>";
    var strHtm64_Install="<br><font color='#FF00FF'>打印控件未安装!点击这里<a href=" + lodopPath + "CLodop_Setup_for_Win32NT_https_2.102.exe target='_self'>执行安装</a>,安装后请刷新页面或重新进入。</font>";
    var strHtm64_Update="<br><font color='#FF00FF'>打印控件需要升级!点击这里<a href=" + lodopPath + "CLodop_Setup_for_Win32NT_https_2.102.exe target='_self'>执行升级</a>,升级后请重新进入。</font>";
    ...
    try{
        ...
        if (LODOP.VERSION<"6.2.0.8") {
            if (needCLodop())
                alert(strCLodopUpdate);
            else if (is64IE) document.write(strHtm64_Update); else
