...
var table_002 = {
    ...
    allowEditByJYZSBZ: function (_this) {
        if (_this.wsxxMap['JYZSBZ'] === '0') {
            $('#table_002 tr:lt(21):gt(14)').find('input').attr('disabled', 'disabled');
            $('#table_002 tr:lt(26):gt(23)').find('input').attr('disabled', 'disabled');
        }
    },
    /**
     * 根据税种类别代码决定不能编辑的行
...
servyouReport.setDataIntoCheckData = function () {
    var obj = {
        ...
        '0_13': $('#002_0_13').val(),//N1附表一:货物：简易征收货劳税额： B1=附表1第10列（8+9a+10+11-14）
...
table_002.bindConfirm = function () {
    ...
    $('#table_002').on('blur', 'input[confirm="Y"]', function () {
