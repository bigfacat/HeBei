<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sb_qysdssbqkcx_B.aspx.cs" Inherits="JlueTaxSystemHeBeiGS.BsfwtWeb.pages.sb.qysds.sb_qysdssbqkcx_B" %>
...
<html>
	<head>
		...
		<script src="../../../scripts/pagejs/sb/qysds/sb_qysdssbqkcx_B.js" type="text/javascript"></script>
		<style type="text/css">
body {
	margin: 0;
	padding: 0;
...
#sdsfxyccx .footer input[button],#tbljcw .footer input,#ssfxts .footer input{
	...
	<body>
		...
		<div style="border-bottom:1px solid #f5f5f5;width:100%;">
			<div class="place pngbg" style="width:1000px;margin: 0 auto;">您现在的位置：我的办税大厅 > 纳税申报 > 企业所得税月(季)度预缴纳税申报表(<span id="titlename">B类</span>，2015年版)</div>
		</div>
		<div>
			<table style="margin: 15px auto 0px auto;">
				<tr>
					...
					<td align="left">
					<input id="sbzldm" name="sbzldm" class="mini-combobox"  valueField="id"  textField="text" value='10417'  data='[{"id":"10417","text":"月报"},{"id":"10419","text":"季报"}]'/> 
					</td>
					<td>
		...
		<!--所得税风险异常查询-->
		<div id="sdsfxyccx" class="mini-window" title="所得税风险异常查询"
		...
		<div id="tbljcw" class="mini-window" title="所得税风险异常查询" style="width:750px;"
		...
		<div id="ssfxts" class="mini-window" title="所得税风险异常查询" style="width:750px;"
			 showToolbar="true" showFooter="true" showModal="true" allowDrag="true">
			<div class="content borderBottom">
				<span>涉税风险提示</span><br />
