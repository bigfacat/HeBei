...
function sb(record) {
	 ...
	 * ***/
    var sblxDm = null;
    if (!!record && !!record.sblxDm) {
        sblxDm = record.sblxDm;
    }
    var hdData = getHdxx();
    ...
    if (!result) {
        ...
        if (fjsBz) {
            ...
            if (YQWRDBZ == '0') {
                if (sblxDm === "03") {
                    window.location.href = '/BsfwtWeb/pages/sb/ybnsrsb/sb_ybnsrsb.aspx?' + sbzlDm + '&correct=Y';
                } else {
                    window.location.href = '/BsfwtWeb/pages/sb/ybnsrsb/sb_ybnsrsb.aspx?' + sbzlDm;
                }
            }
        }
