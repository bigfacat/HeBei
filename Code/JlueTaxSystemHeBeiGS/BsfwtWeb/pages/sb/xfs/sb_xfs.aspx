<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sb_xfs.aspx.cs" Inherits="JlueTaxSystemHeBeiGS.BsfwtWeb.pages.sb.xfs.sb_xfs" %>
...
<head>
    ...
    <script src="../../../scripts/pagejs/sb/xfs/sb_xfscx.js" type="text/javascript"></script>
    <style type="text/css">
        body {
            margin: 0;
            padding: 0;
...
<div style="border-bottom:1px solid #f5f5f5;width:100%;">
    <div class="place pngbg" style="width:1000px;margin: 0 auto;">您现在的位置：我的办税大厅 > 纳税申报 > 其他消费税申报表</div>
</div>
<div>
...
<div class="mini-window" id="gds-win" title="提示" style="width: 460px;display:none;">
    <div>
        <div class="gds-message">
            由于您在地税登记的信息与国税信息不一致，不能通过云厅申报地税业务，但不影响您申报其他消费税申报表（国税业务），
            点击【确定】按钮将跳转至其他消费税申报页面，是否继续？
        </div>
