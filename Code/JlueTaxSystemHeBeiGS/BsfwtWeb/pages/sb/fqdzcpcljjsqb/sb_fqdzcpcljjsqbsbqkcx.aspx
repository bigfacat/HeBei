<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sb_fqdzcpcljjsqbsbqkcx.aspx.cs" Inherits="JlueTaxSystemHeBeiGS.BsfwtWeb.pages.sb.fqdzcpcljjsqb.sb_fqdzcpcljjsqbsbqkcx" %>

<!doctype html>
<html>
	<head>
		<title>我要废弃电器电子产品处理基金申请表申报</title>
		...
		<script src="../../../scripts/pagejs/sb/fqdzcpcljjsqb/sb_fqdzcpcljjsqbsbqkcx.js" type="text/javascript"></script>
		<script src="../../../scripts/pagejs/sb/yqdzClientView.js"></script>
		<style type="text/css">
		body {
			margin: 0;
			padding: 0;
	...
	<body>
		...
		<div style="border-bottom:1px solid #f5f5f5;width:100%;">
			<div class="place pngbg" style="width:1000px;margin: 0 auto;">您现在的位置：我的办税大厅 > 纳税申报 > 废弃电器电子产品处理基金申请表</div>
		</div>
		<div>
