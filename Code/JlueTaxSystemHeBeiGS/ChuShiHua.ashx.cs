...
namespace JlueTaxSystemHeBeiGS
{
    /// <summary>
    /// ChuShiHua 的摘要说明
    /// </summary>
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                if (method == "Clear")
                {
                    ...
                    string path = System.Web.Configuration.WebConfigurationManager.AppSettings["Practicepath"] + "/APIPractice/Chongzuo.asmx/GetHeBeiData?UserId=" + userId + "&ClassId=" + ClassId + "&SortId=" + SortId;
                    string resut = p.HttpGetFunction(path);
                    string billpath = System.Web.Configuration.WebConfigurationManager.AppSettings["tikupath"] + "/GTX/GTXHeBeiUserYSBQC/RedoAllQuestionsHeBei";
