...
//                                     });
                         ...
                         options.error.call(this, req, st);
	                     alert("错误 404 - 文件或服务未找到。", function() {
                             options.failure.call(this, req.responseText);
                         });
                     } else if (st == "error" && req.status == "500") {// 服务出错
                         options.error.call(this, req, st);
	                     alert("服务出错，请联系管理员。", function() {
                             options.failure.call(this, req.responseText);
                         });
                     } else if (st == "timeout") {
                         options.error.call(this, req, st);
                         ...
                         options.error.call(this, req, st);
	                     alert("数据异常，请稍后再试", function() {
                             options.failure.call(this, req.responseText);
                         });
                     } else if(st != "abort"){
                         options.error.call(this, req, st);
	                     alert("连接失败，请检查网络后重试。", function() {
                             options.failure.call(this, req.responseText);
                         });
                     }
                 }
...
$(function() {
    ...
    if(!(SUI.store.get('MHDL') && SUI.store.get('MHDL') === 'Y')){
