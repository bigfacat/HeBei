<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuestionMain.aspx.cs" Inherits="JlueTaxSystemHeBeiGS.QuestionMain" %>
                ...
                success: function (result) {
                    if (typeof (result.Data) == "string") {
                        ...
                        $.each(json, function (i, v) {
                            ...
                            var Gtxpath = "bszm-web/apps/views/simpleCompany/simpleCompany.aspx?userid=" + userId + "&username=" + username + "&classid=" + ClassId + "&courseid=" + courseid + "&sortid=" + sortid + "&questionId=" + v.QuestionId + "&userquestionId=" + v.Id + "&CompanyId=" + v.CompanyId + "&rand=" + new Date().getTime();
                            ...
                            str += '</div>';
                            if (v.VideoID) {
                                str += '<div id="oper' + v.QuestionId + '" style="display: none" class="oper_area"><a class="radius box-shadow ksmc-sj1-tanchuti"  onclick="checkpath(\'' + downpath + '\',\'' + v.FilePath + '\')" target="_blank" style="display:none">下载材料</a><a class="radius box-shadow ksmc-sj1-tanchuti" href="' + Gtxpath + '" target="_blank" onclick="closeareaGTX(' + v.QuestionId + ');">国税申报</a><a target="_blank" class="radius box-shadow ksmc-sj1-tanchuti" onclick="checkvideo(\'' + Gtxvideopath + '\',\'' + v.VideoID + '\',\'国\')" >国税视频</a><span id="TX' + v.QuestionId + '" class="ksmc-cssecond"></span></div>';
                            }
                            else {
                                str += '<div id="oper' + v.QuestionId + '" style="display: none" class="oper_area"><a class="radius box-shadow ksmc-sj1-tanchuti"  onclick="checkpath(\'' + downpath + '\',\'' + v.FilePath + '\')" target="_blank" style="display:none">下载材料</a><a class="radius box-shadow ksmc-sj1-tanchuti" href="' + Gtxpath + '" target="_blank" onclick="closeareaGTX(' + v.QuestionId + ');">国税申报</a><span id="TX' + v.QuestionId + '" class="ksmc-cssecond"></span></div>';
                            }
                            str += '</li>'
                            $("#ulTax").append(str);
                        });
