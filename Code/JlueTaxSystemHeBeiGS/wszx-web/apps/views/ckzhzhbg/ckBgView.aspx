<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ckBgView.aspx.cs" Inherits="JlueTaxSystemHBGS.wszx_web.apps.views.ckzhzhbg.ckBgView" %>

<!DOCTYPE html>


<div class="mini-window" id="ckbg-win" style="width: 1200px; height: 620px; display: none" title="查看存款账户账号" showtoolbar="false">
    <h3 class="txt-c">存款账户账号报告表</h3>
    <div class="txt-c" style="background: #f7f7f7; margin-bottom: 20px; padding: 20px 0">
        <table width="100%" id="ckbg-nsrjbxx-form">
            <tr>
    ...
    <div id="ckbg" class="mini-datagrid" style="width: 1160px; height: 210px;" allowresize="false" enabled="true" showpager="false" showemptytext="true" autoload="false" multiselect="true" allowsortcolumn="false" checkselectiononly="true" allowcellselect="true" allowcelledit="false">
        <div property="columns">
            ...
            <div field="xzqhszDm" displayfield="xzqhszDmText" renderer="ckzhzhbg.xzqhRenderer">行政区划</div>
            <div field="yhkhdjzh" width="200">核准号<br>
                （银行开户登记证号）</div>
            <div field="ffrq" dateformat="yyyy-MM-dd">发证日期</div>
            <div field="yhhbDm" width="150" displayfield="yhhbDmText" renderer="ckzhzhbg.yhzlRenderer">银行种类</div>
            ...
            <div field="khrq" dateformat="yyyy-MM-dd">开户日期</div>
