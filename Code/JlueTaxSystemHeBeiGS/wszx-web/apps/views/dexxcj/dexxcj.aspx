<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dexxcj.aspx.cs" Inherits="JlueTaxSystemHBGS.wszx_web.apps.views.dexxcj.dexxcj" %>
...
<head>
    ...
    <title>个体工商户定额信息采集</title>
    <link rel="stylesheet" href="../../../apps/styles/style.css">
    <link rel="stylesheet" href="./dexxcj.css">
</head>
<body>
    <div id="wizard"></div>
    ...
    <script src="./dexxcjService.js"></script>
    <script src="./dexxcj.js"></script>
</body>
</html>
