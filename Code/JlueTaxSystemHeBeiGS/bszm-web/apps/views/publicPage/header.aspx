<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="header.aspx.cs" Inherits="JlueTaxSystemHBGS.bszm_web.apps.views.publicPage.header" %>
...
<div class="userInfoList" id="qyList">{{if NsrInfo}}<div class="topUserInfo">
    ...
    <img class="userAccountImg" src="../../images/home/userInfoListAccount.png"><ul class="userBaseInfo">
        ...
        <li class="postId" title="信用等级：{{xydj}}">信用级别：<a>{{xydj}}</a></li>
