<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fpyjxxcx.aspx.cs" Inherits="JlueTaxSystemHBGS.yhs_web.wssb.sjcx.fpyjxxcx.fpyjxxcx" %>

<!DOCTYPE html>
<html>
<head lang="en">
    <meta charset="UTF-8">
    <title>发票验旧信息查询</title>
    <!--[if lt IE 9]>
    <link rel="stylesheet" href="../../css/ie.css"/>
    <![endif]-->
    <link rel="stylesheet" type="text/css" href="../../css/ws_default.css" />
    <link rel="stylesheet" type="text/css" href="../../css/header.css" /> 
    <link rel="stylesheet" href="fpyjxxcx.css" />

</head>
<body>

<div class="container">
    <div class="main-title"> 发票验旧信息查询 </div>
    <div class="main">
        <table id="xxcxForm" width="100%" border="0" cellpadding="0" cellspacing="0" style="margin: 0 auto">
            <tbody><tr>
                <th nowrap="nowrap" align="right" width="5%">验旧日期：</th>
        ...
        <div id="xxGrid" class="mini-datagrid" style="width:100%; min-height: 300px; height: auto !important;" height="400px"
            ...
            <div property="columns">
                ...
                <div field="yjrq" headeralign="center" allowsort="false" align="center" width="100">发票验旧日期</div>
...
<script src="fpyjxxcx.js" type="text/javascript"></script>
</body>
</html>
