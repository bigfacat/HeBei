<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="pzhd.aspx.cs" Inherits="JlueTaxSystemHBGS.fpzx_web.apps.views.fpglPzhd.pzhd" %>
...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>发票管理>票种核定</title>
    <link rel="stylesheet" href="../../../apps/styles/style.css">
    <link rel="stylesheet" href="pzhd.css">
</head>
<body>
    <div id="wizard"></div>
    ...
    <script src="pzhdService.js"></script>
    <script src="./pzhdCommon.js"></script>
    <script src="pzhd.js"></script>
</body>
</html>
