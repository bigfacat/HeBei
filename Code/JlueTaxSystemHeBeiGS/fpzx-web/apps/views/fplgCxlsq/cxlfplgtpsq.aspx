<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cxlfplgtpsq.aspx.cs" Inherits="JlueTaxSystemHBGS.fpzx_web.apps.views.fplgCxlsq.cxlfplgtpsq" %>
...
<head>
    ...
    <title>超限量领购发票购票特批申请</title>
    <link rel="stylesheet" href="../../styles/style.css">
    <link rel="stylesheet" href="cxlfplgtpsq.css">
</head>
<body>
    <div id="wizard"></div>
    <div class="mini-window" id="win1" style="width: 760px; height: 600px; display: none" title="增加" showtoolbar="false" showfooter="true">
    ...
    <script src="cxlfplgtpsq.js"></script>
</body>
</html>
