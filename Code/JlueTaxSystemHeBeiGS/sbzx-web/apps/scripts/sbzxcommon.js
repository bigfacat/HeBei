...
var xfs = (function () {
    ...
    var qtlPzlbs = '<option value=""></option>' +
                ...
                '<option value="9">其他</option>';
    return {
        getJmxmmcSelectData: function () {
            return _jmxmmcSelectData;
        },
...
window.wssqUtil = function () {
    ...
    wssq.prepareValidate = function () {
        ...
        var url = '../../../api/validate/beforehand/110209/11.ashx?' + code + '/' + id;
                ...
                if (data.success && data.value) {
                    if (data.value.sbzl[0].qccgbz == 'N') {
                        ...
                        /*if(msg.indexOf('重复申报')>-1){
                            msg = msg + '<br/><a class="goToPay" href="/BsfwtWeb/pages/jk/jk_jsxxcx.html">去缴款>></a>';
                        }*/
                    ...
                    if (msg.indexOf('小规模申报') > -1 && msg.indexOf('重复申报') > -1) {
                        msg = msg + '<br/><a class="goToPay" href="/BsfwtWeb/pages/jk/jk_jsxxcx.aspx">去缴款>></a>';
                        msg = msg + '<br/><a class="goToPay" href="../sbjgcx/sbjgcx.aspx?zsxmDm=10101">申报结果查询>></a>';
