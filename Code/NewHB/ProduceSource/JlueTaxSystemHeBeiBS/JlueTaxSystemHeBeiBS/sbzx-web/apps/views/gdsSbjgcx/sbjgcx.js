...
var sbjgcx = {
    ...
    searchUrl: '/sbzx-web/api/sb/jgcx/sbqkcx.ashx',//查询的API接口
    searchDSxxUrl: '/sbzx-web/api/hb/ds/sb/sbqkcx',//查询地税申报结果的API接口
    zfUrl: '/sbzx-web/api/sbzf/submit/sbzf.ashx',//作废的API接口
    ...
    yearReportSbzlDmArr: [10101, '10110', '10440', '10437', "10438"],
    ...
    viewSbxml: function (_uid) {
        ...
        ajax.post('/sbzx-web/api/sb/jgcx/getsbbw.ashx', mini.encode(cxInfo), function (result) {
            var viewData = '';
            ...
            var viewUrl = sbjgcx.urlMap[sbzlDm]['url'] + '&preview=Y';
            if (viewData.hasOwnProperty('xgmsb_zb')) {
                viewUrl = '/sbzx-web/apps/views/xgmsb-yds/xgmsb-view.html';
            } else if (viewUrl == "/sbzx-web/apps/views/xgmsb-yds_new/ydy.html?sbzlDm=10102&code=10102&preview=Y") {
