...
var xgmsbService = {
	...
	getHdxx: function( params, success, error ){  // 获取核定信息
		...
		ajax.post('/sbzx-web/api/sb/common/get/hdxx.ashx?url='+test, params, success, error);
	},
	
	getSbzl: function( params, success, error ){  // 期初
		ajax.post("/sbzx-web/api/ysbqc/queryysb.ashx", params, success, error);
	},
	
    // 逾期未认定
    queryYqwrd:function () {
        var url ='../../../api/sb/xgmsb/validateYqwrd.ashx';
    ...
    // 批扣户
    queryPkzg: function () {
        var url ='../../../api/sb/xgmsb/validatePkZg.ashx';
        var data = {
