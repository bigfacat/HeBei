...
var qysdsyjbA = {
    ...
    customInit_001: function (_this) {
        ...
        if (this.SBQYLX === '1'){
            ...
            mini.get('xwqy').setRequired(false);
    ...
    setDefaultXwqy_001: function (_this) {
        var ynse = Number($('#001_16_5').val());
        var xwqyCtrl = mini.get('xwqy');
        if (this.SBQYLX === '2' || _this.wsxxMap['BYHBZ'] === 'Y' || this.TSNSR !== '0'){
            xwqyCtrl.setValue('N');
        } else {
            if ((ynse > Number(_this.wsxxMap['XWJMMAXVALUE']) && ((_this.wsxxMap['XXWLBZ'] === '1' && this.YJFS === '1') || _this.wsxxMap['XXWLBZ'] === '0' || _this.wsxxMap['XXWLBZ'] === '2'))
                || (_this.wsxxMap['XXWLBZ'] === '1' && this.YJFS === '3')){
                xwqyCtrl.setValue('N');
            } else if ((ynse <= Number(_this.wsxxMap['XWJMMAXVALUE']) && (((_this.wsxxMap['XXWLBZ'] === '0' || _this.wsxxMap['XXWLBZ'] === '1' || _this.wsxxMap['XXWLBZ'] === '2') && this.YJFS === '1')
                || ((_this.wsxxMap['XXWLBZ'] === '0' || _this.wsxxMap['XXWLBZ'] === '2') && this.YJFS === '2')))
                || (_this.wsxxMap['XXWLBZ'] === '1' && this.YJFS === '2')){
                xwqyCtrl.setValue('Y');
            }
            if (ynse <= Number(_this.wsxxMap['XWJMMAXVALUE']) && (_this.wsxxMap['XXWLBZ'] === '0' || _this.wsxxMap['XXWLBZ'] === '2') && (this.YJFS === '1' || this.YJFS === '2' || this.YJFS === '3')){
                xwqyCtrl.enable();
                $(xwqyCtrl.el).parent().addClass('enable');
            } else {
                xwqyCtrl.disable();
                $(xwqyCtrl.el).parent().removeClass('enable');
            }
        }
    },
    /**
    ...
    doControlYhmx: function () {
        ...
        //其他优惠行次
        // var $trs = $('#table_005 tbody tr:gt(1):lt(27)');
        if (ynse <= Number(servyouReport.wsxxMap['XWJMMAXVALUE']) && ynse > 0.03 && xwqy === 'Y' && hj > 0 && tipsFlag === 'N'){
   ...
   /* /!*控制003 表全部大于0*!/
    ...
    confirmGiveUpXwqy: function (_this) {
        var ynssde = Number($('#001_16_5').val());
        var xwqybz = mini.get('xwqy').getValue();
        if (ynssde <= Number(_this.wsxxMap['XWJMMAXVALUE']) && xwqybz === 'N' && _this.wsxxMap['BYHBZ'] === 'N' && this.YJFS !== '3' && this.SBQYLX !== '2' && this.TSNSR === '0') {
            var that = this;
            mini.confirm("请确认今年预计是否达到享受小微企业税收优惠标准？", "提示", function (action) {
                if (action === "ok") {
                    mini.get('xwqy').setValue('Y')
                } else {
                    that.confirmNeedNotPay(_this);
                }
            });
            return ;
        } else {
    ...
    customEvent: function (_this) {
        _this.tables['001'] && this.bindControlInput001(_this);//001
...
servyouReport.customConfirmBeforeSend = function () {
    qysdsyjbA.confirmGiveUpXwqy(this);
};
servyouReport.changeXml_001 = function () {
    ...
    $sbbxxForm.find('qmcyrs').text(this.getInputValue($('#001_33_2')));
...
servyouReport.customResumeFromXml_001 = function () {
    ...
    this.setTargetVal($('#001_33_2'), $form.find('qmcyrs').text());
};
...
qysdsyjbA.setDefaultXwqy_001 = function (_this) {
    var ynse = Number($('#001_16_5').val());
    var xwqyCtrl = mini.get('xwqy');
    if (this.SBQYLX === '2' || _this.wsxxMap['BYHBZ'] === 'Y' || this.TSNSR !== '0'){
        xwqyCtrl.setValue('N');
        ...
        if ((ynse > Number(_this.wsxxMap['XWJMMAXVALUE']) && (this.YJFS === '1' || _this.wsxxMap['XXWLBZ'] === '0' || _this.wsxxMap['XXWLBZ'] === '2'))
            || (_this.wsxxMap['XXWLBZ'] === '1' && this.YJFS === '3')){
            xwqyCtrl.setValue('N');
            xwqyCtrl.disable();
            $(xwqyCtrl.el).parent().removeClass('enable');
        }/*else if(ynse <= Number(_this.wsxxMap['XWJMMAXVALUE']) && (_this.wsxxMap['XXWLBZ'] === '0' || _this.wsxxMap['XXWLBZ'] === '2') && (this.YJFS === '1' || this.YJFS === '2')){
            xwqyCtrl.setValue('Y');
            xwqyCtrl.enable();
            $(xwqyCtrl.el).parent().addClass('enable');
        }*/ else if(ynse <= Number(_this.wsxxMap['XWJMMAXVALUE']) && (_this.wsxxMap['XXWLBZ'] === '0' || _this.wsxxMap['XXWLBZ'] === '2') && this.YJFS === '3'){
            xwqyCtrl.enable();
            $(xwqyCtrl.el).parent().addClass('enable');
        } else if((ynse <= Number(_this.wsxxMap['XWJMMAXVALUE']) && this.YJFS === '1') || this.YJFS === '2'){
            xwqyCtrl.setValue('Y');
            xwqyCtrl.disable();
            $(xwqyCtrl.el).parent().removeClass('enable');
        }
