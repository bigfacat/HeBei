...
var sbtj = function (request) {
    var result = false;
    ajax.post('../../../api/sb/common/submit/sbcl.ashx', mini.encode(request), function( response ){
...
var ycsCheck = function (request, submitData) {
    var needYcsbd = Api.getData('/sbzx-web/api/sb/sbbd/needBd.ashx', '', 'get').value || false;
