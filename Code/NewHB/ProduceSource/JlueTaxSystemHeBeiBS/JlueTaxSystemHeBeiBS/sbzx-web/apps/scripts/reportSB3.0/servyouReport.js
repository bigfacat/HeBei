...
;(function (root, factory) {
        ...
        bindEvent: function () {
            ...
            $('body').on('click','#sideBar-tip', function () {
                mini.open({
                    ...
                    url: _this.url,        //页面地址
                    title: '填表说明',      //标题
                    width: report.popWindowWidth,      //宽度
                    height: 600,     //高度
    ...
    var Table = function () {
                ...
                $curTable.on('mouseover','td',function () {
                    if ($(this).hasClass('allow-del')){
                        if (!($(this).parent().prev().find('.del-btn-bg').length > 0)){
                            ...
                            $(this).parent().before('<tr class="del-tr" style="position: absolute"><td class="nbr nbb nbl nbt"><div class="del-btn-bg"><a class="btn btn-red del-btn">删除行</a></div></td></tr>');
        ...
        var _validValue = function ($target) {
            ...
            var notOnlyNum = $target.attr('notOnlyNum');
        ...
        var report = {
            ...
            resumeFormula: function (formulaData) {
                ...
                $.each(this.tables, function (sb_id) {
                    if(!$.isArray(formulaData[sb_id])){//说明公式压缩过
