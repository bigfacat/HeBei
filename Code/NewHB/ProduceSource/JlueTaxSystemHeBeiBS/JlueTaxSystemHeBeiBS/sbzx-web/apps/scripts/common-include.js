...
var header = {
    ...
    homeUrl_: '/bszm-web/apps/views-zj/home/home.aspx',//企业首页--默认河北地区
    homeUrl_02: '/bszm-web/apps/views-zj/home/home.html',//个人首页--默认河北地区
    secondUrl: '',//二级菜单  默认我要办税的链接--默认河北地区
    secondName: '我要办税',
    secondType: 'wybs',
    init: function (url) {
        this.loadHeader(url);
    ...
    loadHeader: function (url) {
        ...
        if (store.getSession('getUserInfo') && store.getSession('getUserInfo').AccountInfo) {
            ...
            $.ajax({
                url: '/bszm-web/api/desktop/userInfo/get.ashx',
                type: 'GET',
    ...
    bindCrumbsEvent: function () {
        ...
        $('body').on('click', '#breadcrumb-Nav a', function () {
            ...
            if (type === 'home') {
                return false;
                window.location.href = _this['homeUrl_'];
            } else if (type === 'second') {
                
                var url = _this.secondUrl += '?type=' + _this.secondType + '&userType=' + userType;
...
header.bindCrumbsEvent = function () {
    ...
    $('body').on('click', '#breadcrumb-Nav a', function () {
        ...
        if (type === 'home') {
            ...
            var url = _this.secondUrl;
            if (userInfo.NsrInfo.byhBz === '2') {//报验户
                url += '42020';
            } else if (userType === '01') {//企业
                url += '22020';
            } else if (userType === '02') {//个人
                url += '12020';
            } else if (userType === '03') {//社保户
                url += '32020';
            }
            window.location.href = url;
        }
...
;(function (root, factory) {
    ...
    var hdxxUtil = {
        ...
        hdxxUrl: '../../../api/sb/common/get/hdxx.ashx?url='+test,//取核定的接口
        jkUrl: '',//缴款链接
...
hdxxUtil.getHdxx = function () {
    ...
    if(hdxxData === null){
        ...
        if(sbzlDm === '10115' || sbzlDm === '10116'){
            url = '/sbzx-web/api/sb/fjs/hdxx.ashx?url='+test;
...
sbcommon.sbtj_normal = function (request) {
    ...
    return true;//用于本地测试*/
    var url = '/sbzx-web/api/sb/common/submit/sbcl.ashx';
...
sbcommon.sbtj_year = function (request) {
    // return true;//用于本地测试
    var url = '/sbzx-web/api/sb/common/submit/zlk/zlk.ashx';
    return Api.getIfSuccess(url, request);
};
/**
 * 正常框架申报暂存
...
sbcommon.singleSave_year = function (request) {
    ...
    return true;//用于本地测试*/
    var url = '/sbzx-web/api/sb/common/nb/sbbc.ashx';
    return Api.getIfSuccess(url, request);
};
...
sbcommon.getResumeData_normal = function (request) {
    ...
    var url = '/sbzx-web/api/sb/common/fnb/getSbsj.ashx';
...
sbcommon.getListData = function (request) {
    var url = '/sbzx-web/api/sb/common/initrules.ashx';
    return Api.getData(url, request);
};
/**
 * 年报框架查看时获取列表数据
...
sbcommon.getPreviewListData = function (request) {
    var url = '/sbzx-web/api/sb/jgcx/getYtxsblb.ashx';
...
sbcommon.updateListData = function (request) {
    // return true;//用于本地测试
    var url = '/sbzx-web/api/sb/common/updaterules.ashx';
    return Api.getIfSuccess(url, request);
};
/**
 * 年报框架删除单表数据
...
sbcommon.deleteSingleTableData = function (request) {
    // return true;//用于本地测试
    var url = '/sbzx-web/api/sb/common/sbzc/detelesbb.ashx';
    return Api.getIfSuccess(url, request);
};
/**
...
sbcommon.getHdBySbzlDm = function (sbzlDm,sbny,showErrorMsg) {
    ...
    var test = window.location.pathname + window.location.search;
    var url = '/sbzx-web/api/sb/common/get/hdxx.ashx?url='+test;
    var request = {
        sbzlDm: sbzlDm,
        sbny: sbny
    };
...
sbcommon.ycsCheck = function (request) {
    var url = '/sbzx-web/api/sb/sbbd/zzsbd.ashx';
    return Api.getData(url, request);
};
/**
...
var Api = {
     ...
     * */
    dmToMcMap: {
        'hy': '/sbzx-web/api/baseCode/get/getBaseCodeValueByName/DM_GY_HY.ashx?dm=',//取 行业 名称
        'djzclx': '/sbzx-web/api/baseCode/get/getBaseCodeValueByName/DM_DJ_DJZCLX.ashx?dm=',//取 登记注册类型 名称
        'zzsqylx': '/sbzx-web/api/baseCode/get/getBaseCodeValueByName/DM_GY_ZZSQYLX?dm=',//取 增值税企业类型 名称
        'swjg': '/sbzx-web/api/baseCode/get/getBaseCodeValueByName/DM_GY_SWJG_GT3.ashx?dm=',//取 税务机关 名称
        ...
        'sfzjlx': '/sbzx-web/api/baseCode/get/getBaseCodeValueByName/DM_GY_SFZJLX.ashx?dm='//取 身份证件类型 名称
    },
    ...
    getNsrckzhxx: function () {
        var url = '/sbzx-web/api/base/nsrckzhxx/get.ashx';
    ...
    getDsNsrxxVo: function () {
        return this.getData('/sbzx-web/api/base/dsnsrxx/get.ashx', {});
    }
};
